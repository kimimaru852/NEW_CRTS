<div
    ...
    <div x-show="show"
        ...
        <div class="inventory-head text-sm w-full flex justify-center py-4">
            <div class="flex-1">
                <h3><strong>Office origin:</strong> <span class="underline" x-text="archInventory.office_origin"></span></h3>
                <h3><strong>turn-over date:</strong> <span class="underline" x-text="archInventory.created_at 
                                ? new Date(archInventory.created_at).toLocaleDateString('en-US') : ''"></span></h3>
            </div>
            <div class="flex-1">
                <h3><strong>prepared by:</strong> <span class="underline" x-text="archInventory.prepared_by"></span></h3>
                <h3><strong>approved by:</strong><span x-text="archInventory.manager_approval ?? 'N/A'" class="underline"></span></h3>
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-200">
                    <tr>
                        ...
                        <th class="whitespace-nowrap text-center px-6 py-3 text-xs font-bold text-gray-500 dark:text-green-900 uppercase tracking-wider">RDS Series No</th>
        ...
        <div class="pb-24 text-sm flex justify-center py-4">
            ...
            <div class="flex-1">
                <h3><strong>received by:</strong><span class="underline" x-text="archInventory.received_by" :class="archInventory.approved_by  class="px-2 rounded-full font-bold"></span></h3>
                <h3>
                    <strong>date:</strong>
                    <span class="underline"
                        x-text="archInventory.received_date 
                                ? new Date(archInventory.received_date).toLocaleDateString('en-US') : ''">
                    </span>
                </h3>
                <h3><strong>Validated by:</strong><span class="underline" x-text="archInventory.verified_by" :class="archInventory.verified_by class="px-2 rounded-fullfont-bold"></span></h3>
                <h3>
                    <strong>date:</strong>
                    <span class="underline"
                        x-text="archInventory.verified_date 
                                ? new Date(archInventory.verified_date).toLocaleDateString('en-US') : '—'">
                    </span>
                </h3>
            </div>
        </div>
