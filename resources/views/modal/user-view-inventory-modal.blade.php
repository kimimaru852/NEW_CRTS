<div
    ...
    <div x-show="show"
        ...
        <div class="inventory-head text-sm w-full flex justify-center py-4">
            <div class="flex-1">
                <h3><strong>Office origin:</strong><span x-text="inventory.office_origin" class="underline"></span></h3>
                <h3><strong>turn-over date:</strong><span x-text="new Date(inventory.created_at).toLocaleDateString('en-US') ?? ' '" class="underline"></span></h3>
            </div>
            <div class="flex-1">
                <h3><strong>prepared by:</strong><span x-text="inventory.prepared_by" class="underline"></span></h3>
                <h3><strong>approved by:</strong><span x-text="inventory.manager_approval ?? ' '" class="underline"></span></h3>
            </div>
        </div>
        ...
        <div class=" text-sm flex justify-center py-4">
            ...
            <div class="flex-1">
                <h3><strong>received by:</strong><span x-text="inventory.received_by" class="underline"></span></h3>
                ...
                <h3><strong>validated by:</strong><span x-text="inventory.verified_by" class="underline"></span></h3>
                <h3><strong>date:</strong>
                    <span
                        class="underline"
